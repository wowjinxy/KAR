...
kar_objects = [
    ...
    Object(Matching, "gmclearchecker_8004a648.c", extra_cflags=["-str reuse"]),
    Object(Matching, "gmclearchecker_8004db74.c", extra_cflags=["-str reuse"]),
    ...
    Object(Matching, "aobj.c"),
    Object(NonMatching, "lobj.c"),
    Object(NonMatching, "cobj.c"),
    Object(NonMatching, "fobj.c"),
    Object(NonMatching, "pobj.c"),
    Object(NonMatching, "jobj.c"),
    Object(NonMatching, "displayfunc.c"),
    Object(NonMatching, "initialize.c"),
    Object(NonMatching, "video.c"),
    Object(NonMatching, "controller.c"),
    ...
    Object(Matching, "class.c"),
    Object(NonMatching, "hash.c"),
    ...
    Object(Matching, "hsd/particle/pslist_debugconsole_font.s"),
    Object(NonMatching, "hsd/particle/pslist_data_tail.s"),
...
dolphin_matched = {"arq", "mtxvec", "ppcarch", "db", "init"}
