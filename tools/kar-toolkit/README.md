...
Project-wide resource inventory and address resolution go through `KarProject.ResourceService`, and the `resources`/`resource` CLI commands expose mixed file, HSD root, and A2D entry resources.
