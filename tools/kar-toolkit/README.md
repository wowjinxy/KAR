...
Use `KarProject.Open(KarProjectOptions)` when a tool needs custom output roots, project indexing, archive inspection, data schema registries, operation target-domain rules, or operation preset registries.
