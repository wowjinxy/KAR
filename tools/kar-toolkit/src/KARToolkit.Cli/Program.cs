...
internal static class Program
{
    private static int Main(string[] args)
    {
        ...
        try
        {
            ...
            return command switch
            {
                ...
                "operations" => KarCliInspectionCommands.ShowOperations(options),
                "operation" => KarCliInspectionCommands.ShowOperations(options),
                "operation-plans" => KarCliInspectionCommands.ShowOperations(options),
                "operation-run" => KarCliResourceActionCommands.ExecuteOperation(options),
                "run-operation" => KarCliResourceActionCommands.ExecuteOperation(options),
                "execute-operation" => KarCliResourceActionCommands.ExecuteOperation(options),
                "operation-batch" => KarCliResourceActionCommands.ExecuteOperationBatch(options),
                "operations-run" => KarCliResourceActionCommands.ExecuteOperationBatch(options),
                "run-operations" => KarCliResourceActionCommands.ExecuteOperationBatch(options),
                "execute-operations" => KarCliResourceActionCommands.ExecuteOperationBatch(options),
                "operation-presets" => KarCliInspectionCommands.ShowOperationPresets(options),
                "operation-preset" => KarCliInspectionCommands.ShowOperationPresets(options),
                "presets" => KarCliInspectionCommands.ShowOperationPresets(options),
                ...
                "resource-data" => KarCliInspectionCommands.ShowResourceDataViews(options),
                "resource-data-views" => KarCliInspectionCommands.ShowResourceDataViews(options),
                "resource-data-fields" => KarCliInspectionCommands.ShowResourceDataFields(options),
                "resource-field-tree" => KarCliInspectionCommands.ShowResourceDataFields(options),
                ...
                "resource-data-edit" => KarCliEditCommands.SetResourceDataField(options),
                "set-resource-data" => KarCliEditCommands.SetResourceDataField(options),
                "set-resource-data-field" => KarCliEditCommands.SetResourceDataField(options),
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine("  kar-toolkit operations <source-folder> [operation-id] [--domain <domain>] [--action <action-id>] [--resource-kind <file|root|a2d-entry>] [--read-only|--writes-output] [--can-run|--cannot-run] [--would-write|--would-skip] [--json]");
        Console.WriteLine("  kar-toolkit operation-presets <source-folder> [preset-id] [--domain <domain>] [--action <action-id>] [--available] [--can-run] [--json]");
        Console.WriteLine("  kar-toolkit operation-run <source-folder> <operation-id> [action-args...] [--output <mod-folder>] [--overwrite] [--json]");
        Console.WriteLine("  kar-toolkit operation-batch <source-folder> <action-id> [action-args...] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--output <mod-folder>] [--overwrite] [--continue-on-error] [--json]");
        ...
        Console.WriteLine("  kar-toolkit resources <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--kind <file-kind>] [--category <category>] [--search <text>]");
        ...
        Console.WriteLine("  kar-toolkit resource-contexts <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--kind <file-kind>] [--category <category>] [--search <text>] [--modified|--unchanged|--source-only]");
        Console.WriteLine("  kar-toolkit resource-detail <source-folder> <resource-address> [--output <mod-folder>]");
        Console.WriteLine("  kar-toolkit resource-details <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--kind <file-kind>] [--category <category>] [--search <text>] [--modified|--unchanged|--source-only]");
        Console.WriteLine("  kar-toolkit resource-data <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--kind <file-kind>] [--category <category>] [--search <text>]");
        Console.WriteLine("  kar-toolkit resource-data-fields <source-folder> [resource-address] [field-path-or-name] [--output <mod-folder>] [--kind <file-kind>] [--category <category>] [--search <text>]");
        Console.WriteLine("  kar-toolkit resource-outputs <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--search <text>] [--modified|--unchanged|--source-only]");
        Console.WriteLine("  kar-toolkit resource-output <source-folder> <resource-address> [--output <mod-folder>]");
        Console.WriteLine("  kar-toolkit resource-bytes <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--search <text>] [--modified|--unchanged|--source-only]");
        ...
        Console.WriteLine("  kar-toolkit dump-resource-bytes <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--search <text>] [--modified|--unchanged|--source-only] [--overwrite]");
        Console.WriteLine("  kar-toolkit import-resource <source-folder> <resource-address> <input-file> [--output <mod-folder>]");
        Console.WriteLine("  kar-toolkit apply-resource-outputs <source-folder> [resource-address] [--output <mod-folder>] [--domain <domain>] [--resource-kind <file|root|a2d-entry>] [--search <text>]");
        ...
        Console.WriteLine("  kar-toolkit resource-data-edit <source-folder> <archive:root> <field-path-or-name> <value> [--output <mod-folder>] [--json]");
        ...
        Console.WriteLine("  --continue-on-error");
        ...
        Console.WriteLine("  --domain <files|resources|archives|maps|vehicles|a2d-packages|script-tables|mod-output>");
