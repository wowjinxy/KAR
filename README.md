...
See [docs/wii_mode_loader.md](docs/wii_mode_loader.md) for the standalone and
merged-disc build paths, memory layout, Dolphin launch instructions, and the
mod allocation API. The source-built Wii disc boot stage has no Homebrew
Channel dependency and is documented end to end in
[docs/wii_apploader.md](docs/wii_apploader.md).
