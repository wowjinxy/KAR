...
#define GMCC_TYPE0_REWARD_40 0x66
...
#define GMCC_TYPE0_REWARD_40 0x26
#define GMCC_TYPE2_REWARD_43 0x03
#else
#define GMCC_TYPE0_REWARD_07 0x2F
#define GMCC_TYPE0_REWARD_21 0x1B
#define GMCC_TYPE0_REWARD_38 0x33
...
#if defined(VERSION_GKYJ01)
GmGlobalSaveData *fn_80007620(int);
#elif defined(VERSION_GKYP01)
...
static ClearCheckerRewardEntry ClearChecker_Type0RewardTable[] = {
    ...
    {0x04, 0x01, 0x0C}, {0x04, 0x01, GMCC_TYPE0_REWARD_07}, {0x04, 0x01, 0x45},
    ...
    {0x0B, 0x00, GMCC_TYPE0_REWARD_21}, {0x0C, 0x00, 0x2D}, {0x0D, 0x00, 0x54},
    ...
    {0x06, 0x02, 0x18}, {0x05, 0x01, 0x2C}, {0x05, 0x01, GMCC_TYPE0_REWARD_38},
    {0x05, 0x01, 0x6A}, {0x05, 0x01, GMCC_TYPE0_REWARD_40}, {0x05, 0x01, 0x36},
...
static ClearCheckerRewardEntry ClearChecker_Type2RewardTable[] = {
    ...
    {0x03, 0x00, 0x0C}, {0x08, 0x00, GMCC_TYPE2_REWARD_43},
};
